...
//            int? cityId = (int?)Session["City"];
//            City city = sheduleRepository.Cities.FirstOrDefault(x => x.Id == cityId);
//            Route item = sheduleRepository.Shedule.FirstOrDefault(x => x.Bus.Number == stop.busNumber && x.BusStop.Name == stop.stopName && x.Direction.Name == stop.finalStop && x.Days.Name == stop.days && x.City == city);
